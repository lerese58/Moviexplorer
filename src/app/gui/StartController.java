...
//        for (int i : indexes) rndFilms.put(allFilms.get(i), listOfImg[i]);
        view1.setImage(new Image(Context.relativeFilmDir + allFilms.get(0).getTitle() + ".jpg"));
        view2.setImage(new Image(Context.relativeFilmDir + allFilms.get(1).getTitle() + ".jpg"));
        view3.setImage(new Image(Context.relativeFilmDir + allFilms.get(2).getTitle() + ".jpg"));
        view4.setImage(new Image(Context.relativeFilmDir + allFilms.get(3).getTitle() + ".jpg"));
        view5.setImage(new Image(Context.relativeFilmDir + allFilms.get(4).getTitle() + ".jpg"));
        ...
        searchBtn.setOnAction(event -> openResultList(searchField.getText()));
    ...
    public void openResultList(String toSearch) {
        currentContext.setToSearch(toSearch);
        try {
            resultStage = new Stage();
            Parent resultParent = FXMLLoader.load(getClass().getResource("searchResultList.fxml"));
            resultStage.setScene(new Scene(resultParent));
            resultStage.setTitle("Search results for '" + toSearch + "'");
        } catch (IOException e) {
            e.printStackTrace();
        }
        resultStage.show();
